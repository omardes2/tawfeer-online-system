...
class EmployeeProfile extends Model
{
    ...
    /**
     * هل يستحقّ هذا الموظف الإجازة السنوية ومكافأة نهاية الخدمة؟
     *
     * **الدوام الكامل وحده.** العقد والدوام الجزئيّ في هذا النظام أجرٌ مقابل
     * عمل: لا إجازةَ سنوية تتراكم ولا شهرَ عن كل سنة خدمة. وتركُ الاستحقاق
     * لهما يُنشئ في الميزانية التزامًا لا يقوم على اتفاق.
     *
     * وموضعٌ واحد يقرّر ذلك، تقرأ منه الإجازاتُ ومخصّصُ نهاية الخدمة معًا —
     * فلا يفترق ما تعرضه الشاشة عمّا يُقيَّد في الدفتر.
     */
    public function accruesBenefits(): bool
    {
