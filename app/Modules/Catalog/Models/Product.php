...
class Product extends Model
{
    ...
    /**
     * الأصناف التي عليها عرض — **بتعريف البطاقة نفسه**.
     *
     * البطاقة تقرأ سعرها من المتغيّر الافتراضي: تعرض `promo_price` إن كان أكبر من
     * صفر، وتشطب `retail_price` فوقه، وتحسب نسبة الخصم من الفرق. فلو عرّف هذا
     * النطاق «العرض» بغير ذلك — بمتغيّرٍ آخر يحمل سعرًا ترويجيًّا مثلًا — لظهر في
     * «عروض التوفير» صنفٌ بلا شارة خصم ولا سعرٍ مشطوب، فيُقرأ عطلًا.
     *
     * والشرطان معًا لا أحدهما: سعرٌ ترويجيّ يساوي التجزئة أو يزيد عليها ليس عرضًا،
     * ولا تعرضه البطاقة عرضًا.
     */
    public function scopeOnOffer($query)
    {
        return $query->whereHas('defaultVariant', fn ($q) => $q
            ->where('promo_price', '>', 0)
            ->whereColumn('promo_price', '<', 'retail_price'));
    }
