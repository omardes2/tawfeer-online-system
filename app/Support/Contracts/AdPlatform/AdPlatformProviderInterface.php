 ...
 *
 * العقد **للقراءة وحدها في هذه المرحلة**: يجلب ما صُرف وما نتج، ولا يُنشئ حملةً
 * ولا يوقفها ولا يغيّر ميزانية. تشغيل الإعلانات من داخل النظام مرحلةٌ تالية،
 * وتُضاف بعقدٍ منفصل (`AdPlatformWriterInterface`) لا بتوسيع هذا — فصلٌ مقصود:
 * رمزُ القراءة لا يملك صلاحية الصرف، فخطأٌ في الاستيراد لا يمكن أن يُنفق مالًا.
 *
