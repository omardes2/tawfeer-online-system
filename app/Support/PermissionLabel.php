...
class PermissionLabel
{
    ...
    private const DESCRIPTIONS = [
        ...
        'catalog.price_lists.view' => 'الاطّلاع على قوائم أسعار التجّار وأسعار كل صنف فيها.',
        'catalog.price_lists.manage' => 'تحديد بكم يشتري التاجر — **قرار تسعيرٍ لا إدخال بيانات**: من يعدّلها يتصرّف في هامش الشركة.',
        'sales.abandoned_checkouts.view' => 'قائمة من بدأ الشراء ولم يُكمل، بأرقام هواتفهم. **أرقام زبائن المتجر كلّه لا زبائن المسوّق.**',
        'sales.abandoned_checkouts.manage' => 'تسجيل نتيجة الاتصال بمن لم يُكمل طلبه وإخراجه من قائمة المتابعة.',
        'reports.product_decision.view' => 'ربحية كل صنف وسرعة بيعه وأيام تغطيته واقتراح الشراء. **تكشف التكلفة والهامش.**',
        'reports.sales_by_location.view' => 'توزيع المبيعات على المدن والمناطق.',
        'reports.profit_loss.view' => 'قائمة الأرباح والخسائر كاملة. **تكشف تكلفة الشراء والهامش والصرف الإعلاني وأجرة التوصيل معًا.**',

        // الرواتب: أرقامٌ شخصية. من يراها يرى ما يتقاضاه كل زميلٍ له.
        'hr.employees.view' => 'ملفّات الموظفين ورواتبهم وإجازاتهم ومستحقّاتهم. **راتبُ كل زميلٍ مكشوف لمن يملكها.**',
        'hr.employees.manage' => 'إنشاء ملفّات الموظفين وتسجيل الرواتب والإجازات — **تحديد الراتب قرارٌ لا إدخال بيانات.**',
        'hr.payroll.view' => 'الاطّلاع على مسيّرات الرواتب وبنودها وقيودها.',
        'hr.payroll.manage' => 'توليد المسيّر وترحيله وصرف الرواتب وتصفية مكافأة نهاية الخدمة. **يُخرج نقدًا من الخزينة ويُنشئ قيودًا.**',

        // الصندوق ووكيل المبيعات: صلاحياتٌ تتكلّم باسم الشركة أمام الزبون،
        // فالفرق بين «يردّ» و«يشغّل الوكيل» فرقٌ بين رسالةٍ واحدة وآلافٍ منها.
        'inbox.view' => 'قراءة محادثات واتساب الواردة وسجلّها. **أرقام الزبائن ونصّ كلامهم مكشوفان لمن يملكها.**',
        'inbox.reply' => 'الكتابة إلى الزبون باسم الشركة من داخل المحادثة. ما يُرسَل لا يُسترجَع.',
        'inbox.assign' => 'إسناد المحادثة إلى موظفةٍ بعينها لتتابعها.',
        'ai_agent.handoff' => 'إيقاف الوكيل عن محادثةٍ واحدة وتسليمها لإنسان. لا يعود إليها إلّا بقرارٍ صريح.',
        'ai_agent.toggle' => 'تشغيل الوكيل أو إيقافه على القناة كلّها — **قرارٌ إداريّ**: تشغيلُه يعني أن ذكاءً اصطناعيًّا يحادث كلّ زبون باسم الشركة.',
        'ai_agent.runs.view' => 'مطالعة ما قاله الوكيل ولماذا وبكم: الرسائل والأدوات المستدعاة والتوكنز والتكلفة.',
        'ai_agent.knowledge.view' => 'الاطّلاع على نقاط بيع الأصناف والاعتراضات والأسئلة الشائعة التي يستعملها الوكيل.',
        'ai_agent.knowledge.manage' => 'تحرير ما يقوله الوكيل عن الأصناف ووسمها جاهزة. **ما يُكتب هنا يُقال للزبائن حرفيًّا.**',
    ...
    private const RESOURCES = [
        ...
        'price_lists' => 'قوائم أسعار التجّار',
        'abandoned_checkouts' => 'الطلبات التي لم تكتمل',
        'product_decision' => 'لوحة قرار الصنف',
        'sales_by_location' => 'المبيعات حسب المدن والمناطق',
        'inbox' => 'الصندوق الموحّد',
