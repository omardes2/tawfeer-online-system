...
class PermissionLabel
{
    ...
    private const DESCRIPTIONS = [
        ...
        'marketing.social.view' => 'الاطّلاع على منشورات فيسبوك وإنستغرام المحفوظة ونصوصها وروابطها.',
        'marketing.social.manage' => 'توليد نصوص المنشورات وحفظها وتعديلها وحذفها. لا تنشر شيئًا على أي منصّة — النشر يبقى بيد الإنسان.',
    ...
    private const RESOURCES = [
        ...
        'social' => 'منشورات التواصل الاجتماعي',
        'templates' => 'القوالب',
        'messaging' => 'المراسلة',
        'orders' => 'الطلبات',
        'methods' => 'طرق الدفع',
