...
class PermissionLabel
{
    ...
    private const DESCRIPTIONS = [
        ...
        'hr.payroll.view' => 'الاطّلاع على كشوفات الرواتب وبنودها وقيودها.',
        'hr.payroll.manage' => 'توليد الكشف وترحيله وصرف الرواتب وتصفية مكافأة نهاية الخدمة. **يُخرج نقدًا من الخزينة ويُنشئ قيودًا.**',
