...
class PermissionLabel
{
    ...
    private const DESCRIPTIONS = [
        ...
        'marketing.autopilot.view' => 'الاطّلاع على قرارات الطيّار الآلي للإعلانات وأسبابها وأرقامها — بلا ضبطٍ ولا تنفيذ.',
        'marketing.autopilot.manage' => 'ضبط السقف اليومي وتشغيل الطيّار وإيقاف الإعلانات والتراجع عن قراراته. **الصلاحية الوحيدة التي تُنفق مالًا خارج النظام.**',
    ...
    private const RESOURCES = [
        ...
        'marketing' => 'التسويق',
        'campaigns' => 'الحملات',
        'autopilot' => 'الطيّار الآلي للإعلانات',
        'templates' => 'القوالب',
        'messaging' => 'المراسلة',
        'orders' => 'الطلبات',
        'methods' => 'طرق الدفع',
