...
> **حالة التنفيذ:** ✅ مُنفَّذ ومُختبَر: الفروع والمستودعات والمواقع (2.1)؛ الكتالوج المرجعي — الفئات/العلامات/الوحدات/السمات/قيم السمات/الوسوم (2.2). البقية مُصمَّمة وتُنفَّذ في مراحلها.
