<x-app-layout :title="__('الأرباح والخسائر')">
                ...
                <tbody class="border-t-4 border-gray-100">
                    ...
                    <tr>
                        <td class="ps-8">{{ __('الرواتب والأجور') }}
                            <span class="text-[11px] text-gray-400">{{ __('(من كشوفات الرواتب المُرحَّلة)') }}</span>
                        </td>
                    ...
                    <tr>
                        <td class="ps-8">{{ __('مكافآت وحوافز') }}
                            {{-- والسلف ليست هنا: أصلٌ لا مصروف — مالٌ عند الموظفين يعود. --}}
                            <span class="text-[11px] text-gray-400">{{ __('(ما مُنِح في الفترة — والسلف ليست مصروفًا)') }}</span>
                        </td>
                        <td class="text-start tabular-nums">({{ $money($report['expenses']['bonuses']) }})</td>
                    </tr>
    ...
    <div class="admin-card admin-card-pad mt-5 text-sm text-gray-600 leading-7">
        ...
        <ul class="list-disc ps-5 space-y-1">
            ...
            <li>{{ __('الرواتب ومكافأة نهاية الخدمة تُقرآن من قيود الكشوفات المُرحَّلة — فالمسودّة لا تدخل، والمعكوس يُلغي نفسه.') }}</li>
            <li>
