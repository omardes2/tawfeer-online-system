<x-app-layout :title="__('الأصناف والأسعار')">
    <x-admin.header
        ...
        {{--
            الوصف يتبع العمود لا يخالفه: صاحب القائمة يرى «سعر شرائك» في
            الرأس، فلو بقي الوصف يقول «سعر الجملة» ظنّ أن الرقم المعروض هو
            الجملة العام — وهو ليس كذلك، فيحسب ربحه على أساسٍ خاطئ.
        --}}
        :description="$dealerRange->isEmpty()
            ? __('قائمة أسعار للاطّلاع: سعر البيع وسعر الجملة لكل صنف.')
            : __('قائمة أسعار للاطّلاع: سعر البيع وسعر شرائك لكل صنف — بحسب قائمة الأسعار المخصّصة لك.')"
