...
@php
    ...
    $groups = [
        ...
        ['التقارير والتحليلات', 'chart', [
            ['admin.reports.analytics.index', 'مركز التقارير', 'reports.view', 'admin.reports.analytics.index'],
            ['admin.reports.analytics.dashboard', 'اللوحة التنفيذية', 'reports.executive.view', 'admin.reports.analytics.dashboard'],
            ['admin.reports.analytics.sales', 'تقارير المبيعات', 'reports.sales.view', 'admin.reports.analytics.sales'],
            ['admin.reports.analytics.customers', 'تقارير العملاء', 'reports.customers.view', 'admin.reports.analytics.customers'],
            ['admin.reports.analytics.products', 'تقارير المنتجات', 'reports.products.view', 'admin.reports.analytics.products'],
            ['admin.reports.analytics.inventory', 'تقارير المخزون', 'reports.inventory.view', 'admin.reports.analytics.inventory'],
            ['admin.reports.analytics.shipping', 'تقارير الشحن', 'reports.shipping.view', 'admin.reports.analytics.shipping'],
            ['admin.reports.analytics.financial', 'التقارير المالية', 'reports.financial.view', 'admin.reports.analytics.financial'],
            ['admin.reports.analytics.employees', 'تقارير الموظفين', 'reports.employees.view', 'admin.reports.analytics.employees'],
            ['admin.reports.analytics.marketers', 'تقارير المسوّقين', 'reports.marketers.view', 'admin.reports.analytics.marketers'],
            ['admin.reports.analytics.marketing', 'تقارير التسويق', 'reports.marketing.view', 'admin.reports.analytics.marketing'],
            ['admin.reports.analytics.support', 'خدمة العملاء', 'reports.support.view', 'admin.reports.analytics.support'],
            ['admin.reports.analytics.audit', 'تقارير التدقيق', 'reports.audit.view', 'admin.reports.analytics.audit'],
