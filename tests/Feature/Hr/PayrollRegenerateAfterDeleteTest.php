...
/**
 * إعادة توليد كشفٍ بعد حذف مسودّته.
 *
 * ## العطب
 *
 * الفهرس `payroll_runs_period_unique` على (السنة، الشهر) **لا يعرف الحذف
 * الناعم**: كشفٌ حُذف يبقى محتلًّا شهره في قاعدة البيانات. وكان البحث عن كشف
 ...
 * ```
 *
 * أي خطأ ٥٠٠ في الشاشة بلا رسالةٍ تدلّ عليه — والقائمة تقول «لا كشوفات بعد»
...
class PayrollRegenerateAfterDeleteTest extends TestCase
{
    ...
    /** والكشف المُستعاد هو نفسه برقمه الأول — لا تُحرق أرقامٌ بلا مستند. */
